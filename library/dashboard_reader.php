        ...
        <div class="row">
            <div class="col-md-12">
                <div class="mt-5 mb-3 clearfix">
                    ...
                    <a href="create_reader.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New Reader</a>
                </div>
                ...
                if($result = $mysqli->query($sql)){
                    if($result->num_rows > 0){
                        ...
                        while($row = $result->fetch_array()){
                            ...
                            echo "<td>" ;
                            echo '<a href="read.php?bd_id='. $row['bd_id'] .'" class="mr-3"
                                title="View Record" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
                            echo '<a href="update_reader.php?bd_id='. $row['bd_id'] .'" class="mr-3"
                                title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                            echo '<a href="delete_reader.php?bd_id='. $row['bd_id'] .'" 
